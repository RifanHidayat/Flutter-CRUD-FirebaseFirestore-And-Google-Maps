...
import 'package:sekolah/models/Location.dart';
...
class editData extends StatelessWidget with NavigationStates {
  @override
...
class editDataScreen extends StatefulWidget {
  editDataScreen({this.nama, this.alamat, this.photo, this.id});

  final String nama, alamat, photo, id;
                          ...
                          if ((model.Lat != null) && model.Long != null) {
                            ...
                            services
                                .edit(widget.id,
                                    ...
                                    long: datalong)
                                .then((_) {
                              Toast.show("Data berhasil dibubah", context,
                                  duration: 5, gravity: Toast.BOTTOM);
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: TextFormField(
            ...
            decoration: new InputDecoration(
                hintText: "Masukan Alamat  Sekolah beserta jalan dan kota",
                hintStyle: kHintTextStyle,
                labelText: "Alamat",
                labelStyle: kHintTextStyleLabel,
                enabledBorder: OutlineInputBorder(
