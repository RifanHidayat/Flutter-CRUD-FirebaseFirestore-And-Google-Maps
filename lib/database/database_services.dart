...
final CollectionReference myCollection = Firestore.instance.collection('Sekolah');
class DatabaseServices{
 Future<Sekolah> tambahDataSekolah(String nama, double lat,double long,String alamat,String photo) async {
 ...
 Future<void> edit(String id,{String nama,String alamat,String photo,double lat,double long}) async{
